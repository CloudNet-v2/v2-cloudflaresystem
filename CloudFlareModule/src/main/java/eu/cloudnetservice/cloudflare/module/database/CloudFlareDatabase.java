...
public class CloudFlareDatabase extends DatabaseUsable {
	...
	public void add(PostResponse postResponse) {
		...
		if (document.contains("requests")) {
			...
			Map<String, PostResponse> responses = document.getObject("requests", TypeToken.getParameterized(Map.class, String.class, PostResponse.class).getType());
	...
	public Map<String, MultiValue<PostResponse, String>> getAndRemove() {
		...
		if (document.contains("requests")) {
			...
			Map<String, MultiValue<PostResponse, String>> responses = document.getObject("requests",
                    TypeToken.getParameterized(Map.class,String.class, TypeToken.getParameterized(MultiValue.class, PostResponse.class, String.class).getType()).getType());
